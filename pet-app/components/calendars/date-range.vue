...
const value = ref({
  start: new CalendarDate(yesterday.getFullYear(), yesterday.getMonth(), yesterday.getDate()),
...
watch(value, (newValue) => {
  dateStore.updateDateRange(newValue.start?.toString(), newValue.end?.toString())
}, {deep: true})
