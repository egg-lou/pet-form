      ...
      <div class="h-[85vh] p-10">
        <Tabs v-model="activeTab" default-value="owners">
          ...
          <TabsList class="w-1/4 shadow-md">
            <TabsTrigger value="owners" class="w-full">
                Owners
            </TabsTrigger>
            <TabsTrigger value="pets" class="w-full">
              Pets
            </TabsTrigger>
          </TabsList>
          <div class="flex items-center justify-start w-3/4 relative shadow-md">
            <Search class="w-5 h-5 absolute left-2"/>
            <Input class="pl-8" placeholder="Search" />
          </div>
          </div>
          <TabsContent value="owners" class="py-5 w-full h-[100%]">
              <OwnerTable :owners="owners" />
          </TabsContent>
          <TabsContent value="pets" class="py-5 w-full h-[100%]">
              <PetTable :pets="pets"/>
          </TabsContent>
        </Tabs>
      </div>
