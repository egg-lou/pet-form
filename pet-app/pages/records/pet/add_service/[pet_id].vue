    ...
    z.object({
        ...
        grooming_type: z
            ...
            .refine((value) => value === undefined || value.length > 0, {
                message:
                    'You have to select at least one item or send an empty array.'
            }),
        preventive_care: z
            .object({
                treatment: z
...
<template>
    <div class="main container">
        <Card>
            <div class="flex h-[85vh] flex-col p-10">
                <div class="flex">
                    <div class="w-1/2">
                ...
                <form
                    ...
                    <div class="flex flex-col  border-2 p-3 gap-5">
                        <FormField
                            name="pet_id"
                    ...
                    <div class="flex flex-col">
                     <div class="flex gap-4 w-full h-auto">
                      <div v-if="isGroomingSelected" class="border-2 p-5">
                        <FormField
                            name="grooming_type">
                      ...
                      <div v-if="isPreventiveCareSelected" class="border-2 p-4">
                        <FormField
                            name="treatment">
                          <FormItem class="flex flex-col gap-2">
                            ...
                            <div class="flex flex-col gap-4">
                              ...
                              <FormField
                                  v-for="item in (pet_type === 'Cat') ? preventiveCareTypesCat : preventiveCareTypesDog"
                                  v-slot="{ value, handleChange }"
                                  :key="item.id"
                                  type="checkbox"
                                  :value="item.id"
                              ...
                              <FormField v-slot="{componentField}" name="pet_id">
                                  <FormItem class="flex items-center gap-3 w-full space-y-2">
                                    ...
                                    <Select v-bind="componentField" >
                                      ...
                                      <SelectContent >
                                        <SelectGroup v-for="vet in vetLists" :key="vet.vet_id">
                                          <SelectItem :value="vet.vet_id">{{ vet.vet_name }}</SelectItem>
                                        </SelectGroup>
                                      </SelectContent>
                                    </Select>
                                  </FormItem>
